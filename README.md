...
## Tests
You can compile example1.c and example2.c to test the lib. If output is `A94A8FE5CCB19BA61C4C0873D391E987982FBBD3`, it means that the lib is working correctly.
